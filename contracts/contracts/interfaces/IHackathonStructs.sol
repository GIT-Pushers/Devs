...
/**
 * @title IHackathonStructs
 * @notice Shared data structures and interfaces for Hackathon Platform
 */
interface IHackathonStructs {
    struct Hackathon {
        uint256 id;
        address organizer;
    ...
    event JudgeScoreSubmitted(
        uint256 indexed hackathonId,
        uint256 indexed teamId,
        address indexed judge,
        uint256 score
    );
    event ParticipantVoted(
        uint256 indexed hackathonId,
        uint256 indexed teamId,
        address indexed voter,
        uint256 amount
    );
    event FinalScoreCalculated(
        uint256 indexed hackathonId,
        uint256 indexed teamId,
        uint256 finalScore,
        uint256 ranking
